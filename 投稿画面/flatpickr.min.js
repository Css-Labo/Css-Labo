...
!function(e, t) {
                ...
                if (0 === e || e) {
                    ...
                    if (e instanceof Date)
                        ...
                        if ("today" === s)
                            ...
                            for (var u = void 0, f = [], m = 0, g = 0, p = ""; m < d.length; m++) {
                                var v = d[m],
                                    D = "\\" === v,
                                    C = "\\" === d[m - 1] || D;
                                if (c[v] && !C) {
    ...
    function M(e, r) {
        ...
        function h(e) {
            l.config.noCalendar && 0 === l.selectedDates.length && (l.setDate(void 0 !== l.config.minDate ? new Date(l.config.minDate.getTime()) : (new Date).setHours(l.config.defaultHour, l.config.defaultMinute, l.config.defaultSeconds, 0), !1), M(), re()),
            function(e) {
                e.preventDefault();
                ...
                if (void 0 !== i.value && 2 === i.value.length) {
                    var f = i === l.hourElement,
                        m = i === l.minuteElement;
                    u < o ? (u = r + u + a(!f) + (a(f) && a(!l.amPM)), m && O(void 0, -1, l.hourElement)) : u > r && (u = i === l.hourElement ? u - r - a(!l.amPM) : o, m && O(void 0, 1, l.hourElement)),
                    l.amPM && f && (1 === c ? u + d === 23 : Math.abs(u - d) > c) && (l.amPM.textContent = l.l10n.amPM[a(l.amPM.textContent === l.l10n.amPM[0])]),
                    i.value = n(u)
                }
            }(e),
            0 !== l.selectedDates.length && ("input" !== e.type ? (M(), re()) : setTimeout(function() {
                M(),
                re()
            }, w))
        }
        ...
        function x(e, t, i) {
            ...
            l.hourElement && l.minuteElement && !l.isMobile && (l.hourElement.value = n(l.config.time_24hr ? e : (12 + e) % 12 + 12 * a(e % 12 == 0)), l.minuteElement.value = n(t), void 0 !== l.amPM && (l.amPM.textContent = l.l10n.amPM[a(e >= 12)]), void 0 !== l.secondElement && (l.secondElement.value = n(i)))
        }
        function E(e) {
            var t = parseInt(e.target.value) + (e.delta || 0);
            4 !== t.toString().length && "Enter" !== e.key || (l.currentYearElement.blur(), /[^\d]/.test(t.toString()) || J(t))
        }
        function T(e, t, n, a) {
        ...
        function S() {
            l._animationLoop.forEach(function(e) {
                return e()
            }),
            l._animationLoop = []
        }
        function I(e) {
            if (l.daysContainer && l.daysContainer.childNodes.length > 1)
                switch (e.animationName) {
                case "fpSlideLeft":
                    l.daysContainer.lastChild && l.daysContainer.lastChild.classList.remove("slideLeftNew"),
                    l.daysContainer.removeChild(l.daysContainer.firstChild),
                    l.days = l.daysContainer.firstChild,
                    S();
                    break;
                case "fpSlideRight":
                    l.daysContainer.firstChild && l.daysContainer.firstChild.classList.remove("slideRightNew"),
                    l.daysContainer.removeChild(l.daysContainer.lastChild),
                    l.days = l.daysContainer.firstChild,
                    S()
                }
        }
        function _(e) {
            ...
            case "fpSlideRightNew":
                l.navigationCurrentMonth.classList.remove("slideLeftNew"),
                l.navigationCurrentMonth.classList.remove("slideRightNew");
                for (var t = l.navigationCurrentMonth; t.nextSibling && /curr/.test(t.nextSibling.className);)
                    l.monthNav.removeChild(t.nextSibling);
                for (; t.previousSibling && /curr/.test(t.previousSibling.className);)
                    l.monthNav.removeChild(t.previousSibling);
                l.oldCurMonth = void 0
            }
        }
        function Y(e) {
        ...
        function F(e, t) {
            var n = e + t || 0,
                ...
                i = function() {
                    ...
                    "range" === l.config.mode && U(a)
                };
            if (void 0 === a && 0 !== t)
                return t > 0 ? (l.changeMonth(1, !0, void 0, !0), n %= 42) : t < 0 && (l.changeMonth(-1, !0, void 0, !0), n += 42), j(i);
            i()
        }
        function j(e) {
            !0 === l.config.animate ? l._animationLoop.push(e) : e()
        }
        function L(e) {
            if (void 0 !== l.daysContainer) {
                var t = (new Date(l.currentYear, l.currentMonth, 1).getDay() - l.l10n.firstDayOfWeek + 7) % 7,
                    n = "range" === l.config.mode,
                    a = l.utils.getDaysInMonth((l.currentMonth - 1 + 12) % 12),
                    i = l.utils.getDaysInMonth(),
                    o = window.document.createDocumentFragment(),
                    r = a + 1 - t,
                    c = 0;
                for (l.weekNumbers && l.weekNumbers.firstChild && (l.weekNumbers.textContent = ""), n && (l.minRangeDate = new Date(l.currentYear, l.currentMonth - 1, r), l.maxRangeDate = new Date(l.currentYear, l.currentMonth + 1, (42 - t) % i)); r <= a; r++, c++)
                    o.appendChild(P("prevMonthDay", new Date(l.currentYear, l.currentMonth - 1, r), r, c));
                for (r = 1; r <= i; r++, c++)
                    o.appendChild(P("", new Date(l.currentYear, l.currentMonth, r), r, c));
                for (var d = i + 1; d <= 42 - t; d++, c++)
                    o.appendChild(P("nextMonthDay", new Date(l.currentYear, l.currentMonth + 1, d % i), d, c));
                n && 1 === l.selectedDates.length && o.childNodes[0] ? (l._hidePrevMonthArrow = l._hidePrevMonthArrow || !!l.minRangeDate && l.minRangeDate > o.childNodes[0].dateObj, l._hideNextMonthArrow = l._hideNextMonthArrow || !!l.maxRangeDate && l.maxRangeDate < new Date(l.currentYear, l.currentMonth + 1, 1)) : oe();
                var s = D("div", "dayContainer");
                if (s.appendChild(o), l.config.animate && void 0 !== e)
                    for (; l.daysContainer.childNodes.length > 1;)
                        l.daysContainer.removeChild(l.daysContainer.firstChild);
                else
                    !function(e) {
                        for (; e.firstChild;)
                ...
                e && e >= 0 ? l.daysContainer.appendChild(s) : l.daysContainer.insertBefore(s, l.daysContainer.firstChild),
        ...
        function H() {
            ...
            return e > 0 && e < t.length && (t = t.splice(e, t.length).concat(t.splice(0, e))), l.weekdayContainer.innerHTML = "\n    <span class=flatpickr-weekday>\n      " + t.join("</span><span class=flatpickr-weekday>") + "\n    </span>\n    ", l.weekdayContainer
        }
        function R(e, t, n, a) {
            void 0 === t && (t = !0),
            void 0 === n && (n = l.config.animate),
            void 0 === a && (a = !1);
            var i = t ? e : e - l.currentMonth;
            if (!(i < 0 && l._hidePrevMonthArrow || i > 0 && l._hideNextMonthArrow)) {
                if (l.currentMonth += i, (l.currentMonth < 0 || l.currentMonth > 11) && (l.currentYear += l.currentMonth > 11 ? 1 : -1, l.currentMonth = (l.currentMonth + 12) % 12, ne("onYearChange")), L(n ? i : void 0), !n)
                    return ne("onMonthChange"), oe();
                var o = l.navigationCurrentMonth;
                if (i < 0)
                    for (; o.nextSibling && /curr/.test(o.nextSibling.className);)
                        l.monthNav.removeChild(o.nextSibling);
                else if (i > 0)
                    for (; o.previousSibling && /curr/.test(o.previousSibling.className);)
                        l.monthNav.removeChild(o.previousSibling);
                l.oldCurMonth = l.navigationCurrentMonth,
                l.navigationCurrentMonth = l.monthNav.insertBefore(l.oldCurMonth.cloneNode(!0), i > 0 ? l.oldCurMonth.nextSibling : l.oldCurMonth);
                var r = l.daysContainer;
                if (r.firstChild && r.lastChild && (i > 0 ? (r.firstChild.classList.add("slideLeft"), r.lastChild.classList.add("slideLeftNew"), l.oldCurMonth.classList.add("slideLeft"), l.navigationCurrentMonth.classList.add("slideLeftNew")) : i < 0 && (r.firstChild.classList.add("slideRightNew"), r.lastChild.classList.add("slideRight"), l.oldCurMonth.classList.add("slideRight"), l.navigationCurrentMonth.classList.add("slideRightNew"))), l.currentMonthElement = l.navigationCurrentMonth.firstChild, l.currentYearElement = l.navigationCurrentMonth.lastChild.childNodes[0], oe(), l.oldCurMonth.firstChild && (l.oldCurMonth.firstChild.textContent = g(l.currentMonth - i, l.config.shorthandCurrentMonth, l.l10n)), j(function() {
                    return ne("onMonthChange")
        ...
        function B(e) {
            if (l.isOpen && !l.config.inline) {
                var t = W(e.target),
                    ...
                    a = "blur" === e.type ? n && e.relatedTarget && !W(e.relatedTarget) : !n && !t,
        ...
        function J(e) {
            if (!(!e || l.currentYearElement.getAttribute("data-min") && e < parseInt(l.currentYearElement.getAttribute("data-min")) || l.currentYearElement.getAttribute("data-max") && e > parseInt(l.currentYearElement.getAttribute("data-max")))) {
                ...
                n && (l.redraw(), ne("onYearChange"))
            }
        }
        function K(e, t) {
            void 0 === t && (t = !0);
            var n = l.parseDate(e, void 0, t);
            if (l.config.minDate && n && m(n, l.config.minDate, void 0 !== t ? t : !l.minDateHasTime) < 0 || l.config.maxDate && n && m(n, l.config.maxDate, void 0 !== t ? t : !l.maxDateHasTime) > 0)
                return !1;
        ...
        function $(e) {
            ...
            if (13 === e.keyCode && t) {
                if (a)
                    return l.setDate(l._input.value, !0, e.target === l.altInput ? l.config.altFormat : l.config.dateFormat), e.target.blur();
                l.open()
            } else if (n || i || o) {
                ...
                case 39:
                    if (r)
                        ...
                        e.ctrlKey ? R(c, !0, void 0, !0) : F(e.target.$i, c)
                    }
                    break;
                case 38:
                case 40:
                    ...
                    l.daysContainer && void 0 !== e.target.$i ? e.ctrlKey ? (J(l.currentYear - d), F(e.target.$i, 0)) : r || F(e.target.$i, 7 * d) : l.config.enableTime && (!r && l.hourElement && l.hourElement.focus(), h(e), l._debouncedChange());
                    break;
                case 9:
                ...
                case l.l10n.amPM[0].charAt(0):
                    void 0 !== l.amPM && e.target === l.amPM && (l.amPM.textContent = l.l10n.amPM[0], M(), re());
                    break;
                case l.l10n.amPM[1].charAt(0):
                    void 0 !== l.amPM && e.target === l.amPM && (l.amPM.textContent = l.l10n.amPM[1], M(), re())
                }
                ne("onKeyDown", e)
            }
        }
        function U(e) {
            if (1 === l.selectedDates.length && e.classList.contains("flatpickr-day") && !e.classList.contains("disabled") && void 0 !== l.minRangeDate && void 0 !== l.maxRangeDate) {
                ...
                for (var c = function(r, c) {
                        ...
                        if (s)
                            return u.classList.add("notAllowed"), ["inRange", "startRange", "endRange"].forEach(function(e) {
                    ...
                    }, d = 0, s = l.days.childNodes[d].dateObj; d < 42; d++, s = l.days.childNodes[d] && l.days.childNodes[d].dateObj)
                    c(d, s)
            }
        }
        function q() {
            !l.isOpen || l.config.static || l.config.inline || V()
        }
        function z(e) {
            return function(t) {
                ...
                l.selectedDates && (l.selectedDates = l.selectedDates.filter(function(e) {
                    return K(e)
                }), l.selectedDates.length || "min" !== e || y(n), re()),
                l.daysContainer && (Z(), void 0 !== n ? l.currentYearElement[e] = n.getFullYear().toString() : l.currentYearElement.removeAttribute(e), l.currentYearElement.disabled = !!a && void 0 !== n && a.getFullYear() === n.getFullYear())
            }
        }
        function G() {
            "object" != typeof l.config.locale && void 0 === b.l10ns[l.config.locale] && l.config.errorHandler(new Error("flatpickr: invalid locale " + l.config.locale)),
            l.l10n = t({}, b.l10ns.default, "object" == typeof l.config.locale ? l.config.locale : "default" !== l.config.locale ? b.l10ns[l.config.locale] : void 0),
            c.K = "(" + l.l10n.amPM[0] + "|" + l.l10n.amPM[1] + "|" + l.l10n.amPM[0].toLowerCase() + "|" + l.l10n.amPM[1].toLowerCase() + ")",
            l.formatDate = u(l)
        }
        function V(e) {
            if (void 0 !== l.calendarContainer) {
                ...
                if (v(l.calendarContainer, "arrowTop", !c), v(l.calendarContainer, "arrowBottom", c), !l.config.inline) {
                    ...
                    l.config.static || (l.calendarContainer.style.top = d + "px", f ? (l.calendarContainer.style.left = "auto", l.calendarContainer.style.right = u + "px") : (l.calendarContainer.style.left = s + "px", l.calendarContainer.style.right = "auto"))
                }
            }
        }
        function Z() {
            l.config.noCalendar || l.isMobile || (H(), oe(), L())
        }
        function Q(e) {
            e.preventDefault(),
            e.stopPropagation();
            ...
            if (void 0 !== t) {
                ...
                if (l.selectedDateElem = n, "single" === l.config.mode)
                    ...
                    "range" === l.config.mode && (2 === l.selectedDates.length && l.clear(), l.selectedDates.push(a), 0 !== m(a, l.selectedDates[0], !0) && l.selectedDates.sort(function(e, t) {
                ...
                if (L(), l.config.minDate && l.minDateHasTime && l.config.enableTime && 0 === m(a, l.config.minDate) && y(l.config.minDate), re(), l.config.enableTime && setTimeout(function() {
                    return l.showTimeInput = !0
                }, 50), "range" === l.config.mode && (1 === l.selectedDates.length ? (U(n), l._hidePrevMonthArrow = l._hidePrevMonthArrow || void 0 !== l.minRangeDate && l.minRangeDate > l.days.childNodes[0].dateObj, l._hideNextMonthArrow = l._hideNextMonthArrow || void 0 !== l.maxRangeDate && l.maxRangeDate < new Date(l.currentYear, l.currentMonth + 1, 1)) : oe()), i ? j(function() {
                    return l.selectedDateElem && l.selectedDateElem.focus()
                }) : F(n.$i, 0), void 0 !== l.hourElement && setTimeout(function() {
        ...
        l.close = function() {
            l.isOpen = !1,
            l.isMobile || (l.calendarContainer.classList.remove("open"), l._input.classList.remove("active"));
            ne("onClose")
        },
        l._createElement = D,
        l.destroy = function() {
            void 0 !== l.config && ne("onDestroy");
            for (var e = l._handlers.length; e--;) {
                var t = l._handlers[e];
                t.element.removeEventListener(t.event, t.handler)
            }
            l._handlers = [],
            l.mobileInput ? (l.mobileInput.parentNode && l.mobileInput.parentNode.removeChild(l.mobileInput), l.mobileInput = void 0) : l.calendarContainer && l.calendarContainer.parentNode && l.calendarContainer.parentNode.removeChild(l.calendarContainer);
        ...
        l.open = function(e, t) {
            void 0 === t && (t = l._input);
            if (l.isMobile)
                return e && (e.preventDefault(), e.target && e.target.blur()), setTimeout(function() {
            ...
            var n = l.isOpen;
            l.isOpen = !0,
            n || (l.calendarContainer.classList.add("open"), l._input.classList.add("active"), ne("onOpen"), V(t))
        },
        l.redraw = Z,
        l.set = function(e, t) {
            null !== e && "object" == typeof e ? Object.assign(l.config, e) : (l.config[e] = t, void 0 !== X[e] && X[e].forEach(function(e) {
                return e()
            }));
            l.redraw(),
            Y()
        ...
        function ne(e, t) {
            ...
            "onChange" === e && (l.input.dispatchEvent(ae("change")), l.input.dispatchEvent(ae("input")))
        }
        function ae(e) {
        ...
        function re(e) {
            if (void 0 === e && (e = !0), !l.selectedDates.length)
                return l.clear(e);
        ...
        function le(e) {
            e.preventDefault();
            var t,
                n = l.currentYearElement.parentNode && l.currentYearElement.parentNode.contains(e.target);
            if (e.target === l.currentMonthElement || n) {
                var a = ((t = e).wheelDelta || -t.deltaY) >= 0 ? 1 : -1;
                n ? (J(l.currentYear + a), e.target.value = l.currentYear.toString()) : l.changeMonth(a, !0, !1)
            }
        }
        function ce(e) {
            var t = l.prevMonthNav.contains(e.target),
                n = l.nextMonthNav.contains(e.target);
            t || n ? R(t ? -1 : 1) : e.target === l.currentYearElement ? (e.preventDefault(), l.currentYearElement.select()) : "arrowUp" === e.target.className ? l.changeYear(l.currentYear + 1) : "arrowDown" === e.target.className && l.changeYear(l.currentYear - 1)
        }
        return function() {
            l.element = l.input = e,
            l.isOpen = !1,
            function() {
                ...
                Object.defineProperty(l.config, "disable", {
                    ...
                    set: function(e) {
                        l.config._disable = te(e)
                    }
                }),
                !i.dateFormat && i.enableTime && (c.dateFormat = i.noCalendar ? "H:i" + (i.enableSeconds ? ":S" : "") : b.defaultConfig.dateFormat + " H:i" + (i.enableSeconds ? ":S" : "")),
                i.altInput && i.enableTime && !i.altFormat && (c.altFormat = i.noCalendar ? "h:i" + (i.enableSeconds ? ":S K" : " K") : b.defaultConfig.altFormat + " h:i" + (i.enableSeconds ? ":S" : "") + " K"),
                ...
                for (var u = a.length; u--;)
                    void 0 !== l.config[a[u]] && (l.config[a[u]] = o(l.config[a[u]] || []).map(d));
                for (var u = 0; u < l.config.plugins.length; u++) {
                    var f = l.config.plugins[u](l) || {};
                    for (var m in f)
                        ~a.indexOf(m) ? l.config[m] = o(f[m]).map(d).concat(l.config[m]) : void 0 === i[m] && (l.config[m] = f[m])
                }
            ...
            l.isMobile || function() {
                ...
                if (l.calendarContainer = D("div", "flatpickr-calendar"), l.calendarContainer.tabIndex = -1, !l.config.noCalendar) {
                    if (e.appendChild(function() {
                        ...
                        l.currentMonthElement.title = l.l10n.scrollTitle;
                        var t = C("cur-year", {
                            tabindex: "-1"
                        });
                        return l.currentYearElement = t.childNodes[0], l.currentYearElement.title = l.l10n.scrollTitle, l.config.minDate && l.currentYearElement.setAttribute("data-min", l.config.minDate.getFullYear().toString()), l.config.maxDate && (l.currentYearElement.setAttribute("data-max", l.config.maxDate.getFullYear().toString()), l.currentYearElement.disabled = !!l.config.minDate && l.config.minDate.getFullYear() === l.config.maxDate.getFullYear()), l.nextMonthNav = D("span", "flatpickr-next-month"), l.nextMonthNav.innerHTML = l.config.nextArrow, l.navigationCurrentMonth = D("div", "flatpickr-current-month"), l.navigationCurrentMonth.appendChild(l.currentMonthElement), l.navigationCurrentMonth.appendChild(t), e.appendChild(l.prevMonthNav), e.appendChild(l.navigationCurrentMonth), e.appendChild(l.nextMonthNav), l.monthNav.appendChild(e), Object.defineProperty(l, "_hidePrevMonthArrow", {
                            get: function() {
                    ...
                    }()), l.innerContainer = D("div", "flatpickr-innerContainer"), l.config.weekNumbers) {
                        var t = function() {
                    ...
                    l.rContainer.appendChild(H()),
                    l.daysContainer || (l.daysContainer = D("div", "flatpickr-days"), l.daysContainer.tabIndex = -1),
                    L(),
                ...
                l.config.enableTime && e.appendChild(function() {
                    ...
                    return l.config.time_24hr || (l.amPM = D("span", "flatpickr-am-pm", l.l10n.amPM[a((l.latestSelectedDateObj ? l.hourElement.value : l.config.defaultHour) > 11)]), l.amPM.title = l.l10n.toggleTitle, l.amPM.tabIndex = -1, l.timeContainer.appendChild(l.amPM)), l.timeContainer
                }()),
                v(l.calendarContainer, "rangeMode", "range" === l.config.mode),
                v(l.calendarContainer, "animate", l.config.animate),
            ...
            function() {
                if (l.config.wrap && ["open", "close", "toggle", "clear"].forEach(function(e) {
                    ...
                    var e = i(q, 50);
                    l._debouncedChange = i(N, w),
                    "range" === l.config.mode && l.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && T(l.daysContainer, "mouseover", function(e) {
                        return U(e.target)
                    }),
                    T(window.document.body, "keydown", $),
                    l.config.static || T(l._input, "keydown", $),
                    l.config.inline || l.config.static || T(window, "resize", e),
                    void 0 !== window.ontouchstart && T(window.document.body, "touchstart", B),
                    T(window.document.body, "mousedown", k(B)),
                    T(window.document.body, "focus", B, {
                        capture: !0
                    }),
                    !0 === l.config.clickOpens && (T(l._input, "focus", l.open), T(l._input, "mousedown", k(l.open))),
                    void 0 !== l.daysContainer && (T(l.monthNav, "wheel", le), T(l.monthNav, "mousedown", k(ce)), T(l.monthNav, ["keyup", "increment"], E), T(l.daysContainer, "mousedown", k(Q)), l.config.animate && (T(l.daysContainer, ["webkitAnimationEnd", "animationend"], I), T(l.monthNav, ["webkitAnimationEnd", "animationend"], _))),
                    void 0 !== l.timeContainer && void 0 !== l.minuteElement && void 0 !== l.hourElement && (T(l.timeContainer, ["wheel", "input", "increment"], h), T(l.timeContainer, "mousedown", k(A)), T(l.timeContainer, ["wheel", "input", "increment"], l._debouncedChange, {
                        passive: !0
            ...
            (l.selectedDates.length || l.config.noCalendar) && (l.config.enableTime && y(l.config.noCalendar ? l.latestSelectedDateObj || l.config.minDate : void 0), re(!1)),
    ...
    "object" == typeof window && (window.flatpickr = b),
    b.defaultConfig = h,
    b.l10ns = {
        en: t({}, s),
        default: t({}, s)
    ...
    b.localize = function(e) {
        b.l10ns.default = t({}, b.l10ns.default, e)
    },
    b.setDefaults = function(e) {
        b.defaultConfig = t({}, b.defaultConfig, e)
    },
    b.parseDate = f({}),
    b.formatDate = u({}),
    b.compareDates = m,
